@extends('layouts.app') 
@section('content')
    <div class="col-span-full xl:col-span-8 bg-white rounded-sm border border-gray-200">
                            ...
                            <div class="row" style="width: 1080px">
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="border-2 border-gray-300 p-2 w-full rounded-md" name="ten_hang" value=""></input>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="border-2 border-gray-300 p-2 w-full rounded-md" name="website" value=""></input>
                                    </div>
                                </div>
                            </div>   
                            <div class="row" style="width: 1080px">
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="border-2 border-gray-300 p-2 w-full rounded-md" name="email" value=""></input>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        <label class="text-xl text-gray-600">Số điện thoại</label></br>
                                        <input type="tel" class="border-2 border-gray-300 p-2 w-full rounded-md" name="dienthoai" value=""></input>
                                    </div>
                                </div>
                            </div>  
                            <div class="mb-4" style="width: 1050px">
                                <label class="text-xl text-gray-600">Địa chỉ </label></br>
                                <input  type="text" class="w-full border-2 border-gray-300 p-2 rounded-md" name="dia_chi" ></input>
                            </div>
                            <div class="flex p-1"> 
